...
namespace ResAuthZApi.Infrastructure.DatabaseInit;
...
public class DatabaseInitializer
{
    ...
    private async Task InitTables()
    {
        ...
        // sort files by name to ensure correct order of execution
        var sqlFiles = Directory.GetFiles(sqlFolderPath, "*.sql")
