...
export const COUNTRY_OPTIONS = [
  ...
  { value: 'MAF', label: 'Saint Martin (MAF)' },
  ...
  { value: 'SXM', label: 'Sint Maarten (SXM)' },
  ...
  { value: 'UMI', label: 'U.S. Minor Outlying Islands (UMI)' },
