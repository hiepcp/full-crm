...
export default function useDealsData({ initialFilterColumn = 'company' } = {}) {
  ...
  const fetchData = useCallback(
    async (extraFilters = {}) => {
      ...
      try {
        ...
        // Append explicit filters from DealFilters (status, source)
        ...
        const response = await dealsApi.getAllPaging(
