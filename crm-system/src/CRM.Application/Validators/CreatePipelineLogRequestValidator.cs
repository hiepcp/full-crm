...
{
    /// <summary>
    /// Validator for CreatePipelineLogRequest
    /// </summary>
    public class CreatePipelineLogRequestValidator : AbstractValidator<CreatePipelineLogRequest>
    {
        public CreatePipelineLogRequestValidator()
        {
            // Deal ID validation
            RuleFor(x => x.DealId)
                .GreaterThan(0)
